 ...
 *
 * The followings are the available columns in table 't_answer':
 * @property integer $ID
 ...
 */
class TAnswer extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('ID', 'required'),
			array('ID, questionId', 'numerical', 'integerOnly'=>true),
			array('person', 'length', 'max'=>50),
			array('context, answerDate', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID, questionId, context, person, answerDate', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TAnswer the static model class
	 */
